...
<html lang="en">
    ...
    <body class=" ">
        ...
        if (isset($id)) {
            ...
            $sql = " DELETE FROM car WHERE id='$_GET[u_id]' ";
                                                        ...
                                                        <table id="table_id" style="border-left:0px solid #ddd;border-left:0px solid #ddd;border-bottom:0px solid #ddd"  class="table table-bordered table-hover dataTable no-footer  table-striped  displays">
                                                            <thead >
                                                                <tr>
																	...
																	<th class="numeric" width="5%" style="text-align:center;">Car Type ID</th>
                                                                    <th class="numeric" width="10%" style="text-align:center;">Car Name</th>  
																	<th class="numeric" width="5%" style="text-align:center;">No. Plate</th>
                                                            ...
                                                            <tbody >
                                                                ...
                                                                while ($row = mysqli_fetch_array($result)) {
                                                                    ...
                                                                    <tr >
                                                                        ...
                                                                        <td style="text-align:center;"><?php echo $cartypeid ?></td>
                                                                        <td style="text-align:center;"><?php echo $carname ?></td>
																		<td style="text-align:center;"><?php echo $noplate ?></td>
                                                                        <td style="text-align:center;">

                                                                        <a href="user_update_cardetail.php?id=<?php echo "$id"; ?>"><i class="fa fa-edit" style="color:blue;"></i></a>
                                                                     <a href="admin_details_cardetail.php?u_id=<?php echo "$id"; ?>"><i class="fa fa-trash-o" style="color:red;"></i></a>
                                                                        </td>
                                                                    </tr>
                                                                <?php } ?>
                                                            </tbody>
