                ...
                <div id="page-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <div class="panel panel-orange">
                            <div class="panel-heading">Car Detail <?php echo $type ?>
...
<?php
        if(isset($_POST['submit'])){        
                        $dbc = mysqli_connect(SERVER, USER, PASSWORD, DATABASE) or die('error connecting to MySQL server.');
                           ...
                           $Cid=$_POST['ID'];
                           $Ctypeid=$_POST['cartypeID'];
						   $Cname=$_POST['carname'];
                           $Noplate=$_POST['noplate'];
					       
						  
                           $sql="insert into car(id,car_type_id,car_name,no_plate) values('$Cid','$Ctypeid','$Cname','$Noplate')";
                           mysqli_query($dbc,$sql);
                           
                            echo '<META HTTP-EQUIV="Refresh" Content="0; URL=admin_details_cardetail.php">';
