...
<html lang="en">
    ...
    <body class=" ">
        ...
        if (isset($id)) {
            ...
            $sql = " DELETE FROM booking WHERE id='$_GET[u_id]' ";
                                                        ...
                                                        <table id="table_id" style="border-left:0px solid #ddd;border-left:0px solid #ddd;border-bottom:0px solid #ddd"  class="table table-bordered table-hover dataTable no-footer  table-striped  displays">
                                                            <thead >
                                                                <tr>
																	...
																	<th class="numeric" width="5%" style="text-align:center;">Customer ID</th>
                                                                    <th class="numeric" width="10%" style="text-align:center;">Room ID</th>  
																	<th class="numeric" width="5%" style="text-align:center;">Book Date</th>
                                                            ...
                                                            <tbody >
                                                                ...
                                                                while ($row = mysqli_fetch_array($result)) {
                                                                    ...
                                                                    <tr >
                                                                        ...
                                                                        <td style="text-align:center;"><?php echo $custid ?></td>
                                                                        <td style="text-align:center;"><?php echo $roomid ?></td>
																		<td style="text-align:center;"><?php echo $bookdate ?></td>
                                                                        <td style="text-align:center;">

                                                                        <a href="user_update_booking.php?id=<?php echo "$id"; ?>"><i class="fa fa-edit" style="color:blue;"></i></a>
                                                                     <a href="admin_details_booking.php?u_id=<?php echo "$id"; ?>"><i class="fa fa-trash-o" style="color:red;"></i></a>
                                                                        </td>
                                                                    </tr>
                                                                <?php } ?>
                                                            </tbody>
