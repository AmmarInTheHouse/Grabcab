                ...
                <div id="page-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <div class="panel panel-orange">
                            <div class="panel-heading">Booking <?php echo $type ?>
                                <a href="csv_dse.php?type=<?php echo $type;?>" class="pull-right" style="color: white"></a>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="form-body pal">
                                           <div class=" col-md-6 form-group">
                                                ...
                                                <!--<label for="ID" class="col-md-3 control-label">ID <span class="require">*</span></label>

                                                <div class="col-md-9">
                                                    <div class="input-icon"><i class="fa fa-user"></i>
                                                        <input id="ID" name="ID" tabindex="1"  type="text"  placeholder="ID" class="form-control" >
                                                    </div>
                                                </div>-->
												<label for="Customer ID" class="col-md-3 control-label">Customer ID <span class="require">*</span></label>

                                                <div class="col-md-9">
                                                    <div class="input-icon"><i class="fa fa-user"></i>
                                                        <input id="custID" name="custID" tabindex="2" type="text" required placeholder="Customer ID" class="form-control">
                                                    </div>
                                                </div>
                                            </div> 
                                            <div class=" col-md-6 form-group">
                                                <!--<label for="Car Type" class="col-md-3 control-label">Car Type ID <span class="require">*</span></label>

                                                <div class="col-md-9">
                                                    <div class="input-icon"><i class="fa fa-user"></i>
                                                        <input id="cartypeID" name="cartypeID" tabindex="2" type="text" required placeholder="Car Type ID" class="form-control">
                                                    </div>
                                                </div>-->
												<input id="type" name="type" type="hidden" value="<?php echo $type ?>" class="form-control" >

                                                <label for="Room ID" class="col-md-3 control-label">Room ID<span class="require">*</span></label>

                                                <div class="col-md-9">
                                                    <div class="input-icon"><i class="fa fa-user"></i>
                                                        <input id="roomID" name="roomID" tabindex="1"  type="text" required placeholder="Room ID" class="form-control" >
                                                    </div>
                                                </div>
                                            </div>
                                            <br>
                                            <br>
                                             <div class=" col-md-6 form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon"><i class="fa fa-user"></i>
                                                        <input id="carname" name="carname" tabindex="1"  type="text" required placeholder="Car name" class="form-control" >
                                                    </div>
                                                </div>-->
												 <label for="Booking Date" class="col-md-3 control-label">Booking Date<span class="require">*</span></label>

                                                <div class="col-md-9">
                                                    <div class="input-icon"><i class="fa fa-user"></i>
                                                        <input id="bookingdate" name="bookingdate" tabindex="2" type="date" required placeholder="Booking Date" class="form-control">
                                                    </div>
                                                </div>
                                            </div> 
                                            <div class=" col-md-6 form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon"><i class="fa fa-user"></i>
                                                        <input id="noplate" name="noplate" tabindex="2" type="text" required placeholder="No. Plate" class="form-control">
                                                    </div>
                                                </div>-->
                                            </div>
                                            <br>
                                            <br>
                                              <div style="background:white" class="form-actions text-right pal">
                                    <input type="submit" tabindex="20" id="submit" name="submit" value="Add" class="btn btn-success" />
                                </div>
...
<?php
        if(isset($_POST['submit'])){        
                        $dbc = mysqli_connect(SERVER, USER, PASSWORD, DATABASE) or die('error connecting to MySQL server.');
                           ...
                           $sql="insert into booking(customer_id,room_id,book_date) values('$Custid','$Roomid','$Bookdate')";
                           mysqli_query($dbc,$sql);
                           
                            echo '<META HTTP-EQUIV="Refresh" Content="0; URL=admin_details_booking.php">';
    ...
    ?>
                     ...
                     <!--   <div class="panel panel-orange">
                            ...
                            <div class="panel-body pan">
                              ...
                              <div class="form-body pal">
                                    <?php if ($type == "Retailer" || $type == "Distributor" || $type == "DSE") {
                                        ?>
                                        <div class="row">
                                            <div class="col-md-4">
                                                    ...
                                                    <div class="input-icon right">
                                                        ...
                                                        <select id="assigned_route" name="assigned_route" value="<?php echo $assigned_route; ?>" tabindex="13" type="text" required class="form-control">
                                                           <?php
															...
															$sql11="select assigned_route from demo_number where type='DSE' ";
