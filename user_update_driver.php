...
<html lang="en">
	...
	$result = mysqli_query($dbc, "select * from driver where id='$_REQUEST[id]'");
                ...
                <div id="page-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <div class="panel panel-orange">
                            <div class="panel-heading">Add Driver <?php echo $type ?>
                                           ...
                                           <div class=" col-md-6 form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon"><i class="fa fa-user"></i>
                                                        <input id="name" name="name" tabindex="1"  type="text" value="<?php echo $Dname; ?>" class="form-control" >
                                                    </div>
                                                </div>
                                            </div> 
                                            <div class=" col-md-6 form-group">
                                                <label for="password" class="col-md-3 control-label">Phone no. <span class="require">*</span></label>

                                                <div class="col-md-9">
                                                    <div class="input-icon"><i class="fa fa-user"></i>
                                                        <input id="phone" name="phone" tabindex="2" type="text" required value="<?php echo $Dphoneno; ?>" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            <br>
                                            <br>
                                             <div class=" col-md-6 form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon"><i class="fa fa-user"></i>
                                                        <input id="username" name="username" tabindex="1"  type="text" value="<?php echo $Duser; ?>" class="form-control" >
                                                    </div>
                                                </div>
                                            </div> 
                                            <div class=" col-md-6 form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon"><i class="fa fa-key"></i>
                                                        <input id="password" name="password" tabindex="2" type="text" value="<?php echo $Dpass; ?>" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            <br>
                                             ...
                                             <div class=" col-md-6 form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon">
                                                        <input id="id" name="id" tabindex="1"  type="hidden" value="<?php echo $Did; ?>" class="form-control" >
                                                    </div>
                                                </div>
                                            </div> 
                                              <div class="form-actions text-right pal">
                                    <input type="submit" tabindex="20" id="submit" name="submit" value="Update" class="btn btn-success" />
                                </div>
        ...
        if(isset($_POST['submit'])){        
           ...
           // echo($sql);
                           mysqli_query($dbc,$sql);
                            ...
                            echo '<META HTTP-EQUIV="Refresh" Content="0; URL=admin_details_driver.php">';
