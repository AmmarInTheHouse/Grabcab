                ...
                <div id="page-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <div class="panel panel-orange">
                            <div class="panel-heading">Room<?php echo $type ?>
                                    ...
                                    <div class="row">
                                        <div class="form-body pal">
                                           <div class=" col-md-6 form-group">
												...
												<label for="Room No" class="col-md-3 control-label">Room Number<span class="require">*</span></label>

                                                <div class="col-md-9">
                                                    <div class="input-icon"><i class="fa fa-user"></i>
                                                        <input id="roomno" name="roomno" tabindex="2" type="text" required placeholder="Room Number" class="form-control">
                                                    </div>
                                                </div>
                                            </div> 
...
<?php
        if(isset($_POST['submit'])){        
                        $dbc = mysqli_connect(SERVER, USER, PASSWORD, DATABASE) or die('error connecting to MySQL server.');
                           ...
                           $sql="insert into room(room_number) values('$RoomNo')";
                           mysqli_query($dbc,$sql);
                           
                            echo '<META HTTP-EQUIV="Refresh" Content="0; URL=admin_details_room.php">';
