...
<html lang="en">
    ...
    <body class=" ">
        ...
        if (isset($id)) {
            ...
            $sql = " DELETE FROM car_type WHERE id='$_GET[u_id]' ";
            ...
            <meta http-equiv="refresh" content="0;url=admin_details_cartype.php">
            <?php
        }
        ?>
        <div>
                                                        ...
                                                        <table id="table_id" style="border-left:0px solid #ddd;border-left:0px solid #ddd;border-bottom:0px solid #ddd"  class="table table-bordered table-hover dataTable no-footer  table-striped  displays">
                                                            <thead >
                                                                <tr>
                                                                    ...
                                                                    <th class="numeric" width="10%" style="text-align:center;">Car Type</th>
                                                                ...
                                                                while ($row = mysqli_fetch_array($result)) {
                                                                  ...
                                                                  $Cartype = $row["car_type"];
                                                                    ...
                                                                    <tr >
                                                                        ...
                                                                        <td style="text-align:center;"><?php echo $Cartype ?></td>
                                                                        
                                                                        <td style="text-align:center;">

                                                                            <a href="user_update_cartype.php?id=<?php echo "$Cid"; ?>"><i class="fa fa-edit" style="color:blue;"></i></a>
                                                                            <a href="admin_details_cartype.php?u_id=<?php echo "$Cid"; ?>"><i class="fa fa-trash-o" style="color:red;"></i></a>
                                                                        </td>
                                                                    </tr>
                                                                <?php } ?>
                                                            </tbody>
