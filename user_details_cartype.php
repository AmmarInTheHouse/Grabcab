                ...
                <div id="page-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <div class="panel panel-orange">
                            <div class="panel-heading">Add Cartype <?php echo $type ?>
                                    ...
                                    <div class="row">
                                        <div class="form-body pal">
                                           <div class=" col-md-6 form-group">
                                                ...
                                                <label for="Username" class="col-md-3 control-label">Car Type <span class="require">*</span></label>

                                                <div class="col-md-9">
                                                    <div class="input-icon"><i class="fa fa-user"></i>
                                                        <input id="cartype" name="cartype" tabindex="1"  type="text" required placeholder="Car type" class="form-control" >
                                                    </div>
                                                </div>
                                            </div> 
                                            <div class=" col-md-6 form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon">
                                                        <input id="id" name="id" tabindex="2" type="hidden" required placeholder="phone" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            <br>
...
<?php
        if(isset($_POST['submit'])){        
                        $dbc = mysqli_connect(SERVER, USER, PASSWORD, DATABASE) or die('error connecting to MySQL server.');
                           ...
                           $sql="insert into car_type(id,car_type) values('$carid','$cartype')";
                           mysqli_query($dbc,$sql);
                           
                            echo '<META HTTP-EQUIV="Refresh" Content="0; URL=admin_details_cartype.php">';
