...
<html lang="en">
	...
	$result = mysqli_query($dbc, "select * from car_type where id='$_REQUEST[id]'");
                                           ...
                                           <div class=" col-md-6 form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon"><i class="fa fa-user"></i>
                                                        <input id="cartype" name="cartype" tabindex="1"  type="text" value="<?php echo $cartype; ?>" class="form-control" >
                                                    </div>
                                                </div>
                                            </div> 
                                            <div class=" col-md-6 form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon">
                                                        <input id="id" name="id" tabindex="2" type="hidden" value="<?php echo $carid; ?>" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            <br>
