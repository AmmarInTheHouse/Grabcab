...
<html lang="en">
    ...
    <body class=" ">
        ...
        if (isset($id)) {
            ...
            $sql = " DELETE FROM journey WHERE id='$_GET[u_id]' ";
                                    ...
                                    <div class="portlet box">
                                                        ...
                                                        <table id="table_id" style="border-left:0px solid #ddd;border-left:0px solid #ddd;border-bottom:0px solid #ddd"  class="table table-bordered table-hover dataTable no-footer  table-striped  displays">
                                                            <thead >
                                                                <tr>
                                                                    ...
                                                                    <th class="numeric" width="10%" style="text-align:center;">Book_ID</th>
                                                                    
                                                                    <th class="numeric" width="10%" style="text-align:center;">Customer_ID</th>
                                                                     <th class="numeric" width="10%" style="text-align:center;">Driver_ID</th>
                                                                      <th class="numeric" width="10%" style="text-align:center;">Date</th>
                                                                       <th class="numeric" width="10%" style="text-align:center;">Time</th>
                                                                        <th class="numeric" width="10%" style="text-align:center;">PickUp_Latitude</th>
                                                                         <th class="numeric" width="10%" style="text-align:center;">PickUp_Longitude</th>
                                                                          <th class="numeric" width="10%" style="text-align:center;">Drop_Latitude</th>
                                                                           <th class="numeric" width="10%" style="text-align:center;">Drop_Longitude</th>
										...
										$dlong=$row["drop_long"];
                                                                    ...
                                                                    <tr >
                                                                        ...
                                                                        <td style="text-align:center;"><?php echo $c_id ?></td>
                                                                        <td style="text-align:center;"><?php echo $d_id ?></td>
                                                                        <td style="text-align:center;"><?php echo $jdate ?></td>
                                                                        <td style="text-align:center;"><?php echo $jtime?></td>
                                                                        <td style="text-align:center;"><?php echo $plat ?></td>
                                                                        <td style="text-align:center;"><?php echo $plong ?></td>
                                                                        <td style="text-align:center;"><?php echo $dlat ?></td>
                                                                        <td style="text-align:center;"><?php echo $dlong ?></td>
                                                                        <td style="text-align:center;">

                                                                            <a href="user_update_journey.php?id=<?php echo "$id"; ?>"><i class="fa fa-edit" style="color:blue;"></i></a>
                                                                            <a href="admin_details_journey.php?u_id=<?php echo "$id"; ?>"><i class="fa fa-trash-o" style="color:red;"></i></a>
                                                                        </td>
                                                                    </tr>
                                                                <?php } ?>
                                                            </tbody>
