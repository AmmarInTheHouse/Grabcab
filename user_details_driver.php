                                           ...
                                           <div class=" col-md-6 form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon"><i class="fa fa-user"></i>
                                                        <input id="name" name="name" tabindex="1"  type="text" required placeholder="name" class="form-control" >
                                                    </div>
                                                </div>
                                            </div> 
                                            <div class=" col-md-6 form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon"><i class="fa fa-user"></i>
                                                        <input id="phone" name="phone" tabindex="2" type="text" required placeholder="phone" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            <br>
                                            ...
                                            <div class=" col-md-6 form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon"><i class="fa fa-key"></i>
                                                        <input id="password" name="password" tabindex="2" type="text" required placeholder="password" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            <br>
