                ...
                <div id="page-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <div class="panel panel-orange">
                            <div class="panel-heading">Journey<?php echo $type ?>
                                           ...
                                           <div class=" col-md-6 form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon"><i class="fa fa-user"></i>
                                                        <input id="bookid" name="bookid" tabindex="1"  type="text" required placeholder="Book ID" class="form-control" >
                                                    </div>
                                                </div>
                                            </div> 
                                            <div class=" col-md-6 form-group">
                                            ...
                                            <br>
                                             <div class=" col-md-6 form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon"><i class="fa fa-user"></i>
                                                        <input id="driverid" name="driverid" tabindex="1"  type="text" required placeholder="Driver ID" class="form-control" >
                                                    </div>
                                                </div>
                                            </div> 
                                            <div class=" col-md-6 form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon"><i class="fa fa-user"></i>
                                                        <input id="date" name="date" tabindex="2" type="date" required placeholder="Date" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            <br>
											...
											<div class=" col-md-6 form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon"><i class="fa fa-user"></i>
                                                        <input id="time" name="time" tabindex="1"  type="text" required placeholder="Time" class="form-control" >
                                                    </div>
                                                </div>
                                            </div> 
                                            ...
                                            <div class=" col-md-6 form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon"><i class="fa fa-user"></i>
                                                        <input id="pickuplat" name="pickuplat" tabindex="2" type="text" required placeholder="Pickup Latitude" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
											<br>
											...
											<div class=" col-md-6 form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon"><i class="fa fa-user"></i>
                                                        <input id="pickuplog" name="pickuplog" tabindex="1"  type="text" required placeholder="PickUp Longitude" class="form-control" >
                                                    </div>
                                                </div>
                                            </div> 
                                            <div class=" col-md-6 form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon"><i class="fa fa-user"></i>
                                                        <input id="droplat" name="droplat" tabindex="2" type="text" required placeholder="Drop Latitude" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
											<br>
											...
											<div class=" col-md-6 form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-icon"><i class="fa fa-user"></i>
                                                        <input id="droplog" name="droplog" tabindex="1"  type="text" required placeholder="Drop Longitude" class="form-control" >
                                                    </div>
                                                </div>
                                            </div> 
											<br>
...
<?php
        if(isset($_POST['submit'])){        
                        $dbc = mysqli_connect(SERVER, USER, PASSWORD, DATABASE) or die('error connecting to MySQL server.');
						   ...
						   $Pickuplog=$_POST['pickuplog'];
						   $Droplat=$_POST['droplat'];
						   $Droplog=$_POST['droplog'];
						  
                           $sql="insert into journey(book_id,customer_id,driver_id,date,time,pickup_lat,pickup_long,drop_lat,drop_long) values('$Bookid','$Custid','$Driverid','$Date','$Time','$Pickuplat','$Pickuplog','$Droplat','$Droplog')";
