...
<html lang="en">
    ...
    <body class=" ">
        ...
        if (isset($id)) {
            ...
            $sql = " DELETE FROM customer WHERE id='$_GET[u_id]' ";
            ...
            <meta http-equiv="refresh" content="0;url=admin_details_customer.php">
            <?php
        }
        ?>
        <div>
                                                                ...
                                                                while ($row = mysqli_fetch_array($result)) {
                                                                    ...
                                                                    <tr >
                                                                        ...
                                                                        <td style="text-align:center;">
                                                                            ...
                                                                            <a href="user_update_customer.php?id=<?php echo "$id"; ?>"><i class="fa fa-edit" style="color:blue;"></i></a>
                                                                            <a href="admin_details_customer.php?u_id=<?php echo "$id"; ?>"><i class="fa fa-trash-o" style="color:red;"></i></a>
                                                                        </td>
                                                                    </tr>
                                                                <?php } ?>
                                                            </tbody>
