                ...
                <div id="page-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <div class="panel panel-orange">
                            <div class="panel-heading">Customer <?php echo $type ?>
                                    ...
                                    <div class="row">
                                        <div class="form-body pal">
                                           <div class=" col-md-6 form-group">
												...
												<label for="name" class="col-md-3 control-label">Customer Name<span class="require">*</span></label>

                                                <div class="col-md-9">
                                                    <div class="input-icon"><i class="fa fa-user"></i>
                                                        <input id="name" name="name" tabindex="2" type="text" required placeholder="Customer Name" class="form-control">
                                                    </div>
                                                </div>
                                            </div> 
                                            <div class=" col-md-6 form-group">
                                                ...
                                                <label for="Number" class="col-md-3 control-label">Phone Number<span class="require">*</span></label>

                                                <div class="col-md-9">
                                                    <div class="input-icon"><i class="fa fa-user"></i>
                                                        <input id="number" name="number" tabindex="1"  type="text" required placeholder="Phone Number" class="form-control" >
                                                    </div>
                                                </div>
                                            </div>
                                            <br>
...
<?php
        if(isset($_POST['submit'])){        
                        $dbc = mysqli_connect(SERVER, USER, PASSWORD, DATABASE) or die('error connecting to MySQL server.');
                           ...
                           $sql="insert into customer(name,phone) values('$Custname','$Number')";
                           mysqli_query($dbc,$sql);
                           
                            echo '<META HTTP-EQUIV="Refresh" Content="0; URL=admin_details_customer.php">';
